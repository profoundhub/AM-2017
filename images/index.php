						...
						<!-- Panel (Banner) -->
							<section class="panel banner right">
								<div class="content color0 span-3-75">
									...
									is America Luigi</h1>
									<p>This is <strong>America Luigi</strong>, a novelty game app created for fun and entertainment for ALL ages to play.</p>
									<ul class="actions">
										<li><a href="#first" class="button special color1 circle icon fa-angle-right">Next</a></li>
									</ul>
								</div>
								<div class="image filtered span-1-75" data-position="25% 25%">
									<img src="images/AL-Team.png" alt="" />
								</div>
							</section>
						...
						<!-- Panel (Spotlight) -->
							<section class="panel spotlight medium right" id="first">
								...
								<div class="image filtered tinted" data-position="top left">
									<img src="images/AmFbBg1-Ready1.jpg" alt="" />
								</div>
							</section>
							...
							<section class="panel color1">
								...
								<div class="inner">
									<ul class="grid-icons three connected">
										...
										<li><span class="icon fa-snapchat-ghost"><span class="label">Dolor</span></span></li>
										<li><span class="icon fa-whatsapp"><span class="label">Sit</span></span></li>
										<li><span class="icon fa-youtube"><span class="label">Amet</span></span></li>
										<li><span class="icon fa-instagram"><span class="label">Nullam</span></span></li>
									</ul>
								</div>
							</section>
							...
							<section class="panel">
								...
								<div class="gallery">
									...
									<div class="group span-4-5">
										...
										<a href="images/AM-photos-5.jpg" class="image filtered span-1-5" data-position="center"><img src="images/AM-photos-5.jpg" alt="" /></a>
										<a href="images/AM-photos-8.jpg" class="image filtered span-1-5" data-position="bottom"><img src="images/AM-photos-8.jpg" alt="" /></a>
										<a href="images/AM-photos-9.jpg" class="image filtered span-3" data-position="top"><img src="images/AM-photos-9.jpg" alt="" /></a>
									</div>
